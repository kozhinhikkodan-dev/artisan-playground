...
<body>
    ...
    <script>
        ...
        function executeCommand() {
            ...
            executeBtn.innerHTML = '<span class="spinner me-1"></span> Executing...';
            ...
            // Execute command
            fetch('{{ route('artisan-playground.execute') }}', {
                method: 'POST',
                headers: {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    commandOutput.style.color = '#10b981';
                } else {
            ...
            .finally(() => {
                ...
                executeBtn.innerHTML = '<i class="fas fa-play me-1"></i> Execute Command';
            });
        }
